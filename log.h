...
#define DEBUG_T(format, string...)      {LOG_Log_P(PSTR("[%5u][%5u] "),ulSystemTickMS, ulIdleTimeMS);     LOG_Log(format, ##string);}
#define DEBUG_P(format, string...)      {                                           LOG_Log_P(format, ##string);}
#define DEBUG_T_P(format, string...)    {LOG_Log_P(PSTR("[%5u][%5u] "),ulSystemTickMS, ulIdleTimeMS);     LOG_Log_P(format, ##string);}
